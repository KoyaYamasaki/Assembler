...
//        let currentPath = FileManager.default.currentDirectoryPath
        ...
        parser = Parser(inputUrl: inputUrl)

        createOutputFile(inputUrl: inputUrl, outputFile: outputFile)
        start()
    }

    static func createOutputFile(inputUrl: URL, outputFile: String) {
        outputFileUrl = inputUrl.deletingLastPathComponent().appendingPathComponent(outputFile)
